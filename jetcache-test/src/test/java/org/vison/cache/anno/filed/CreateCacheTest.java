package org.vison.cache.anno.filed;
...
import org.vison.cache.MultiLevelCacheConfig;
import org.vison.cache.ProxyCache;
import org.vison.cache.RefreshCacheTest;
import org.vison.cache.anno.CachePenetrationProtect;
import org.vison.cache.anno.CacheRefresh;
...
import org.vison.cache.embedded.EmbeddedCacheConfig;
import org.vison.cache.embedded.LinkedHashMapCache;
import org.vison.cache.external.ExternalCacheConfig;
import org.vison.cache.external.MockRemoteCache;
...
public class CreateCacheTest extends SpringTest {
    ...
    @Configuration
    @ComponentScan(basePackages = "org.vison.cache.test.beans")
    @EnableMethodCache(basePackages = "org.vison.cache.test.beans")
